...
const loadContent = async (id = "1000") => {
    ...
    try {
        ...
        errorMsgContainer.classList.add("max-w-md", "h-64", "mx-auto", "my-24", "space-y-8");
...
const displayContent = (contents) => {
    ...
    contents.forEach(content => {
        ...
        contentCard.classList.add("w-full", "card", "card-compact");
        contentCard.innerHTML = `
        <figure class="relative">
        <img class="w-full lg:w-[312px] h-[200px]" src="${content.thumbnail}" alt="${content.title}" />
